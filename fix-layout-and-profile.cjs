...
// Fix Layout.tsx with signout button
...
`);
console.log('Layout.tsx updated with signout button');

// Create Profile page with set password
...
`);
console.log('Profile.tsx created');

// Update App.tsx to include Profile route
fs.writeFileSync('src/App.tsx', `import { Switch, Route, Redirect } from "wouter";
...
`);
console.log('App.tsx updated with Profile route');
